...
use Mortezamasumi\FbEssentials\Tests\Services\FbEssentialsPanelProvider;
...
class TestCase extends Orchestra
{
    protected function setUp(): void
    {
        ...
        //     fn (string $modelName) => 'Mortezamasumi\\FbEssentials\\Database\\Factories\\'.class_basename($modelName).'Factory'
        // );
    }
    ...
    protected function getPackageProviders($app)
    {
        return [
            ...
            // FbEssentialsPanelProvider::class,
        ];
    }
}
